  ...
  <div>
    <div class="table-item">
      <button
        ...
        class="delete-activity small-btn"
        :class="{ pressed: deleteClicked }"
      ...
      <span
        id="up"
        title="Up Vote"
        :class="{ pressed: increaseClicked }"
        class="small-btn"
        @click="increase(activity)"
      >
        <svg
          width="34"
          height="10"
      ...
      <span
        id="down"
        title="Down Vote"
        :class="{ pressed: decreaseClicked }"
        class="small-btn"
        @click="decrease(activity)"
      >
        <svg
          width="34"
          height="10"
...
.table-item {
  ...
  box-shadow: 9px 9px 9px rgb(0, 0, 0, 0.03),
    -9px -9px 9px rgba(218, 218, 218, 0.1);
  font-size: 1.5em;
  padding: 1rem;
  border-radius: 10px;
  grid-template-areas:
...
.small-btn {
  ...
  height: 35px;
  width: 35px;
  box-shadow: 8px 8px 8px rgb(0, 0, 0, 0.08),
    -8px -8px 8px rgba(255, 255, 255, 0.03);
}
...
@-webkit-keyframes pressed {
  0% {
    box-shadow: 5px 5px 5px rgb(0, 0, 0, 0.08),
      -5px -5px 5px rgba(255, 255, 255, 0.03);
  }

  50% {
    box-shadow: -1px -1px 1px rgba(0, 0, 0, 0, 0.3),
